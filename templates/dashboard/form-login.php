...
<section>
	<div class="container-fluid sign-in-wrapper <?php echo ! $bg ? 'no-login-background' : '' ?>">
		...
		<div class="text-container-block" style="display:none;">
			<div class="text-container">
					<p> Moteur24.ma utilise vos données personnelles pour créer la meilleure expérience possible. Découvrez-en plus sur vos droits en matière de données.</p>
			</div>
		</div>
