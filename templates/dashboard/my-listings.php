					...
					<td class="listing-info">
						<?php if ( $package = $listing->get_product() ): ?>
							<div class="info listing-package">
								<div class="label"><?php _ex( 'Pack:', 'User listings dashboard', 'my-listing' ) ?></div>
								<div class="value"><?php echo esc_html( $package->get_name() ) ?></div>
							</div>
						<?php endif ?>
						<div class="info created-at">
							<div class="label"><?php _ex( 'Poster le:', 'User listings dashboard', 'my-listing' ) ?></div>
						...
						<div class="info expires-at">
							<div class="label"><?php _ex( 'Expire le:', 'User listings dashboard', 'my-listing' ) ?></div>
							<div class="value">
