...
class Edit_Listing_Form extends Add_Listing_Form {
	...
	public function submit_handler() {
		...
		// add success message
		$save_message = _x( 'Vos changements ont été enregistrés.', 'Edit listing form', 'my-listing' );
		...
		if ( 'publish' === $post_status ) {
			...
			$save_message = _x( 'Vos modifications ont été soumises et votre annonce sera à nouveau visible une fois approuvée.', 'Edit listing form', 'my-listing' );
		}
