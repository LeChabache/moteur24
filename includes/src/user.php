...
class User extends \WP_User {
	...
	public function get_author_m24_badges() {
		return $this->author_m24_badges;
	}
	
	public function get_premium_customer() {
		return $this->premium_customer;
	}
	
	public function get_score_du_publicateur() {
		return $this->score_du_publicateur;
	}
	...
	public function get_gallery_dimages() {
		return $this->gallery_dimages;
	}
