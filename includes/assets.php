...
class Assets {
	...
	public function print_head_content() {
		...
		$case27 = [
			...
			'l10n' => [
				'selectOption' => _x( 'Sélectionner une option', 'Dropdown placeholder', 'my-listing' ),
				'errorLoading' => _x( "Les résultats n'ont pas pu être chargés.", 'Dropdown could not load results', 'my-listing' ),
				'removeAllItems' => _x( 'Supprimer tous les éléments', 'Dropdown could not load results', 'my-listing' ),
				'loadingMore'  => _x( 'Chargement de plus de résultats…', 'Dropdown loading more results', 'my-listing' ),
				'noResults'    => _x( 'Aucun résultat trouvé', 'Dropdown no results found', 'my-listing' ),
				'searching'    => _x( 'Chargement...', 'Dropdown searching', 'my-listing' ),
				'datepicker'   => [
				...
				'irreversible_action' => _x( "Ceci est une action irréversible. Continuer malgré tout?", 'Alerts: irreversible action', 'my-listing' ),
				'delete_listing_confirm' => _x( 'Êtes-vous sûr de vouloir supprimer cette annonce ?', 'Alerts: delete listing', 'my-listing' ),
				'copied_to_clipboard' => _x( 'Copié!', 'Alerts: Copied to clipboard', 'my-listing' ),
				'nearby_listings_location_required' => _x( 'Entrez un emplacement pour trouver les annonces à proximité.', 'Nearby listings dialog', 'my-listing' ),
				'nearby_listings_retrieving_location' => _x( "Récupération de l'emplacement...", 'Nearby listings dialog', 'my-listing' ),
				'nearby_listings_searching' => _x( "Recherche d'annonces à proximité...", 'Nearby listings dialog', 'my-listing' ),
				'geolocation_failed' => _x( 'Moteur24 cherche votre emplacement..', 'Explore map', 'my-listing' ),
				'something_went_wrong' => __( "Quelque chose s'est mal passé.", 'my-listing' ),
				'all_in_category' => _x( 'Tous dans "%s"', 'Category dropdown', 'my-listing' ),
				'invalid_file_type' => _x( 'Type de fichier invalide. Types acceptés :', 'Add listing form', 'my-listing' ),
				'file_limit_exceeded' => _x( 'Vous avez dépassé la limite de téléchargement de (%d).', 'Add listing form', 'my-listing' ),
			],
			'woocommerce' => [],
		];
