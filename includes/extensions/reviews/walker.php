		...
		<li <?php comment_class( $parent_class . $other_classes ); ?> id="comment-<?php comment_ID() ?>">
			<div class="comment-container">
				<div class="comment-head">
					...
					<span class="comment-date"><?php comment_date() ?> <?php _e( 'à', 'my-listing' ) ?> <?php comment_time() ?> <?php edit_comment_link( esc_html__('&middot; Edit', 'my-listing') ); ?></span>
				...
				<div class="reply comment-info">
					...
					comment_reply_link( array_merge( $args, array(
						...
						'reply_text' => '<i style="top: 4px;font-size: 16px;" class="fa fa-ellipsis-h"></i>' . __( 'Répondre', 'my-listing' ),
						))); ?>
				</div>
			</div>
