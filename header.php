...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-60PXRN131D"></script>
	<script>
	window.dataLayer = window.dataLayer || [];
	function gtag(){dataLayer.push(arguments);}
	gtag('js', new Date());

	gtag('config', 'G-60PXRN131D');
	</script>
</head>
<body <?php body_class(); ?>>
<?php
...
printf( '<div id="c27-site-wrapper"><div id="m24-loader"></div>' );
